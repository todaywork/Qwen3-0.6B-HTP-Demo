...
chcp 65001 >nul
title Qwen3-0.6B-HTP Batch Inference Tool
cd /d "%~dp0"
...
echo ============================================================================
echo Qwen3-0.6B-HTP Batch Inference Tool
...
if not errorlevel 1 (
    py -3 "%~dp0run_batch_inference.py" --input-excel "%INPUT_EXCEL%" --clean-device-history %*
) else (
    ...
    python "%~dp0run_batch_inference.py" --input-excel "%INPUT_EXCEL%" --clean-device-history %*
)
