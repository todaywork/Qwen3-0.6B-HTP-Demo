...
/**
 * @brief An enum which defines the data types for dialog parameters.
 */
typedef enum {
  GENIE_DATATYPE_INT_32   = 10,
  GENIE_DATATYPE_UINT_32  = 12,
  GENIE_DATATYPE_UINT_64  = 14,
  GENIE_DATATYPE_FLOAT_32 = 20,
  GENIE_DATATYPE_STRING   = 30,
} Genie_DataType_t;
...
/**
 * @brief A union to hold values of different data types.
 */
typedef union {
  int32_t int32Value;
