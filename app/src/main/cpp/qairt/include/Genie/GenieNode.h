...
/**
 * @brief A client-defined callback function to get model produced outputs.
 *
 * @param[in] data Dimensions of the embedding buffer.
 *
 * @param[in] dataSize Size of the buffer in bytes.
 *
 * @param[in] outputConfig Format of output data in JSON.
 *
 * @param[in] userData The userData field provided to GenieNode_getData.
 *
 * @return None
 *
 */
typedef void (*GenieNode_IOCallback_t)(const void* data,
...
/**
 * @brief A function to create a node configuration from a DLC.
 *
 ...
 *
 * @param[in] dataConfig Optional data configuration.
 *
 * @return Status code:
 *         - GENIE_STATUS_SUCCESS: API call was successful.
 *         - GENIE_STATUS_ERROR_INVALID_HANDLE: Node handle is invalid.
...
/**
 * @brief A function to train a node.
 *
 * @param[in] nodeHandle A node handle prepared for training.
 *
 * @return Status code:
 *         - GENIE_STATUS_SUCCESS: API call was successful.
 *         - GENIE_STATUS_ERROR_INVALID_HANDLE: Node handle is invalid.
...
/**
 * @brief A function to save LoRA Adapter.
 *
 * @param[in] nodeHandle A node handle.
 *
 * @param[in] engine Engine from which the LoRA Adapter is being saved.
 *
 ...
 * @param[in] nodeIOName Node IO name.
 *
 * @param[in] ioConfig IO Config specifying any specific parameters in json format.
 *
 * @param[in] ioCallback user defined callback for getting output.
 *
 * @param[in] userData The userData field provided to getData.
 *
 * @return Status code:
 *         - GENIE_STATUS_SUCCESS: API call was successful.
 *         - GENIE_STATUS_ERROR_INVALID_HANDLE: Node handle is invalid.
...
/**
 * @brief A function to call execute on a node.
 *
 * @param[in] nodeHandle A node handle.
 *
 * @param[in] executionConfig execution Config in json format.
 *
 * @param[in] userData The userData field provided to execute.
 *
 * @return Status code:
 *         - GENIE_STATUS_SUCCESS: API call was successful.
 *         - GENIE_STATUS_ERROR_INVALID_HANDLE: Node handle is invalid.
...
/**
 * @brief A function to reset a node.
 *
 * @param[in] nodeHandle A node handle.
 *
 * @return Status code:
