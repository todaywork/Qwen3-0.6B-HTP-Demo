...
public final class ProfileMetrics {
    ...
    public long generatedTokens = -1;
    public long timeToFirstTokenUs = -1;
    public long durationUs = -1;
    public long tokenGenerationTimeUs = -1;
    public double promptTokensPerSecond = 0.0;
    public double generatedTokensPerSecond = 0.0;

    // Token 交叉验证字段
    public long profilePromptTokens = -1;   // Genie SDK profile 原始值
    public long manualPromptTokens = -1;    // JNI 层手动 encode 值
    public boolean tokenMismatch = false;
    public long tokenDiff = 0;
